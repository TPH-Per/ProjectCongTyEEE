...
- Name: no-mock-runtime.spec.ts >> production router does not expose legacy mock customer flow
- Location: e2e\no-mock-runtime.spec.ts:12:1
...
Expected substring: not "CustomerLayout"
Received string:        "import {
  createRouter,
  createWebHistory,
  type RouteRecordRaw,
} from \"vue-router\";

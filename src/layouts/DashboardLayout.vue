    ...
    <aside class="w-60 border-r border-[hsl(var(--border))] bg-white flex flex-col shrink-0">
      ...
      <div class="p-3 border-t border-[hsl(var(--border))] space-y-1">
        <div class="flex items-center gap-2.5 px-3 py-2 rounded-2xl bg-[hsl(var(--muted))]">
          ...
          <button class="flex items-center gap-2 p-1 px-2 rounded-lg hover:bg-white text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--foreground))] transition-colors" @click="$router.push('/select-branch')">
            ...
            <span class="text-xs font-semibold">Chọn nhánh</span>
          </button>

<template>
  <div class="flex h-screen bg-gray-50 overflow-hidden font-sans text-gray-800">
    ...
    <aside class="w-64 bg-gradient-to-b from-gray-900 via-[#1a1a1a] to-black shadow-[4px_0_24px_rgba(0,0,0,0.5)] flex flex-col z-20 border-r border-gray-800">
      ...
      <div class="p-4 border-t border-white/10 relative overflow-hidden flex flex-col gap-1">
        <button @click="$router.push('/select-branch')" class="flex items-center text-sm text-gray-500 hover:text-gray-300 transition-colors w-full px-4 py-2 relative z-10">
        ...
        <button class="flex items-center text-sm text-gray-500 hover:text-red-400 transition-colors w-full px-4 py-2 relative z-10 border-t border-white/10 mt-1 pt-3" @click="handleSignOut">

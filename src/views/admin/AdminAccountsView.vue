  ...
  <div class="space-y-6 max-w-7xl mx-auto">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-4 shadow-sm flex items-center gap-4">
      <div class="flex-1 relative">
        ...
        <input type="text" :placeholder="t('auto_t_m_t_n_m_nh_n_vi_n', 'Tìm tên, mã nhân viên...')" class="w-full bg-gray-50 border border-gray-200 rounded-xl pl-9 pr-4 py-2.5 text-sm focus:outline-none focus:border-gray-400 font-medium" />
      </div>

...
<template>
  <div class="bg-white border border-gray-200 rounded-3xl p-6 md:p-8 w-full max-w-lg shadow-2xl relative flex flex-col gap-6 text-[#333333] select-none">
    ...
    <div class="text-center pt-2">
      <h3 class="text-xl font-black text-[#333333] mb-1.5 font-serif tracking-wide">Đánh Giá Trải Nghiệm</h3>
      <p class="text-xs text-gray-500">Đóng góp của bạn giúp Ngưu Cát cải thiện món ăn & dịch vụ</p>
    </div>
    ...
    <div v-if="rating > 0" class="flex flex-col gap-1.5">
      ...
      <textarea v-model="comment"
                rows="2"
                placeholder="Nhập ý kiến đóng góp của bạn tại đây... ví dụ: Phục vụ rất nhanh, món ngon!"

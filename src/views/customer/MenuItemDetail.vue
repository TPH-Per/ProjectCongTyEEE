        ...
        <div class="p-6 flex-1 overflow-y-auto flex flex-col gap-4">
          ...
          <div class="bg-black/30 p-3.5 rounded-xl border border-gray-900">
            ...
            <p class="text-xs text-gray-300 leading-relaxed">
              {{ item.description || 'Thịt bò vân mỡ cẩm thạch tuyệt hảo, được chế biến với nước sốt độc quyền đậm đà hương vị truyền thống.' }}
            </p>
          </div>
          ...
          <div class="grid grid-cols-3 gap-2 text-[11px] font-bold text-gray-400">
            <div class="bg-gray-900/60 border border-gray-800 p-2.5 rounded-xl text-center flex flex-col items-center justify-center gap-1">
              ...
              <span class="text-white truncate max-w-full">Không đậu phộng</span>
            </div>
            <div class="bg-gray-900/60 border border-gray-800 p-2.5 rounded-xl text-center flex flex-col items-center justify-center gap-1">
              <span class="text-gray-500">🔥 Độ cay</span>
              <span class="text-[#ff9800]">Nhẹ</span>
            </div>
            <div class="bg-gray-900/60 border border-gray-800 p-2.5 rounded-xl text-center flex flex-col items-center justify-center gap-1">

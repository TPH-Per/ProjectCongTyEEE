<!-- File: src/views/reception/InventoryView.vue -->
<template>
  <div class="revenue-container">
    ...
    <header class="revenue-header flex-shrink-0">
      <div class="header-left">
        ...
        <h1 class="page-title">Tồn kho tức thời | <span class="branch-name">NGƯU CÁT</span></h1>
      </div>
    ...
    <div class="content-section flex-1 overflow-y-auto">
      <div class="status-card">
        <h2>📦 Tồn kho tức thời</h2>
        <p>Tính năng xem và kiểm tra tồn kho nguyên vật liệu đang được phát triển.</p>
      </div>
    </div>
  </div>
</template>

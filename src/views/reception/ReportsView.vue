...
const invoicesData = ref([
  {
    ...
    type: "restaurant",
    date: "2026-07-18",
    soPhieu: "CN3126071800001",
    soHoaDon: "C26MQV",
    dayHD: "A",
    mstKhachHang: "0102030405",
    trangThai: "Đã xuất HĐĐT",
    khu: "Khu A",
    ban: "A01",
    tongTien: 2998800,
    daTra: 3000000,
    ...
    soLanIn: 2,
    tgTao: "18/07/2026 11:15:30",
    tgDong: "18/07/2026 12:45:20",
    mayTao: "POS-01",
    ghiChu: "",
    slKhach: 2,
  ...
  },
  {
    ...
    type: "restaurant",
    date: "2026-07-18",
    soPhieu: "CN3126071800002",
    soHoaDon: "C26MQW",
    dayHD: "B",
    mstKhachHang: "",
    trangThai: "Chưa xuất HĐĐT",
    khu: "Khu A",
    ban: "A02",
    tongTien: 5997600,
    daTra: 5997600,
    ...
    soLanIn: 1,
    tgTao: "18/07/2026 11:20:15",
    tgDong: "18/07/2026 13:10:00",
    mayTao: "POS-02",
    ghiChu: "",
    slKhach: 4,
  ...
  },
  {
    ...
    nguoiTao: "Dương Thị Mộng Mơ",
    soLanIn: 1,
    tgTao: "18/07/2026 11:30:00",
    tgDong: "18/07/2026 13:25:40",
    mayTao: "POS-01",
    ghiChu: "Khách quen nợ cuối tháng",
    slKhach: 1,
    phucVu: "Dương Thị Mộng Mơ",
    quanLy: "Trần Thu Ngân",
    lyDoGiam: "",
  ...
  },
  {
    ...
    type: "restaurant",
    date: "2026-07-18",
    soPhieu: "CN3126071800004",
    soHoaDon: "C26MQX",
    dayHD: "A",
    mstKhachHang: "0312987654",
    trangThai: "Đã xuất HĐĐT",
    khu: "Khu B",
    ban: "B01",
    tongTien: 14997000,
    ...
    nguoiTao: "Phan Quỳnh Như",
    soLanIn: 3,
    tgTao: "18/07/2026 11:00:00",
    tgDong: "18/07/2026 13:30:00",
    mayTao: "POS-02",
    ghiChu: "Tiệc công ty 10 người",
    slKhach: 10,
    phucVu: "Phan Quỳnh Như",
    quanLy: "Trần Thu Ngân",
    lyDoGiam: "",
  ...
  },
  {
    ...
    tienCoc: 0,
    thuNgan: "Dương Thị Mộng Mơ",
    khachHang: "Phạm Thị Dung",
    nguoiTao: "Dương Thị Mộng Mơ",
    soLanIn: 1,
    tgTao: "18/07/2026 12:15:00",
    tgDong: "18/07/2026 12:20:00",
    mayTao: "POS-01",
    ghiChu: "Khách đổi ý không ăn",
    slKhach: 2,
    phucVu: "Dương Thị Mộng Mơ",
    quanLy: "Trần Thu Ngân",
    lyDoGiam: "",
  ...
  },
  {
    ...
    nguoiTao: "Phan Quỳnh Như",
    soLanIn: 1,
    tgTao: "18/07/2026 12:30:00",
    tgDong: "18/07/2026 13:15:00",
    mayTao: "POS-02",
    ghiChu: "Tặng Voucher Marketing",
    slKhach: 1,
    phucVu: "Phan Quỳnh Như",
    quanLy: "Trần Thu Ngân",
    lyDoGiam: "Voucher 100% từ Marketing",
    nhanVienGoiLai: "",
    soLanTamTinh: 1,
    nguoiInCuoi: "Phan Quỳnh Như",
    tgInCuoi: "18/07/2026 13:15:00",
    status: "gift",
    selected: false,
  },
  {
    ...
    tienCoc: 3000000,
    thuNgan: "Dương Thị Mộng Mơ",
    khachHang: "Gia đình Hoàng",
    nguoiTao: "Dương Thị Mộng Mơ",
    soLanIn: 2,
    tgTao: "18/07/2026 12:40:00",
    tgDong: "18/07/2026 14:00:00",
    mayTao: "POS-01",
    ghiChu: "Giữ bill đối chiếu cuối ca",
    slKhach: 5,
    phucVu: "Dương Thị Mộng Mơ",
    quanLy: "Trần Thu Ngân",
    lyDoGiam: "",
  ...
  },
  {
    ...
    nguoiTao: "Phan Quỳnh Như",
    soLanIn: 2,
    tgTao: "18/07/2026 12:00:00",
    tgDong: "18/07/2026 14:15:00",
    mayTao: "POS-02",
    ghiChu: "Phòng riêng - tiệc sinh nhật",
    slKhach: 8,
    phucVu: "Phan Quỳnh Như",
    quanLy: "Trần Thu Ngân",
    lyDoGiam: "",
  ...
  },
  {
    ...
    tienCoc: 0,
    thuNgan: "Dương Thị Mộng Mơ",
    khachHang: "Đặng Thu Thảo",
    nguoiTao: "Dương Thị Mộng Mơ",
    soLanIn: 2,
    tgTao: "18/07/2026 13:00:00",
    tgDong: "18/07/2026 14:30:00",
    mayTao: "POS-01",
    ghiChu: "Gọi lại kiểm tra món",
    slKhach: 2,
    phucVu: "Dương Thị Mộng Mơ",
    quanLy: "Trần Thu Ngân",
    lyDoGiam: "",
    nhanVienGoiLai: "Dương Thị Mộng Mơ",
    soLanTamTinh: 1,
    nguoiInCuoi: "Dương Thị Mộng Mơ",
    tgInCuoi: "18/07/2026 14:30:00",
    status: "recall",
    selected: false,
  },
  {
    ...
    type: "restaurant",
    date: "2026-07-18",
    soPhieu: "CN3126071800011",
    soHoaDon: "C26MQZ",
    dayHD: "B",
    mstKhachHang: "0123456789",
    trangThai: "Đã xuất HĐĐT",
    khu: "Khu R",
    ban: "R02",
    tongTien: 8996400,
    ...
    tienCoc: 0,
    thuNgan: "Phan Quỳnh Như",
    khachHang: "Phạm Minh Hoàng",
    nguoiTao: "Phan Quỳnh Như",
    soLanIn: 1,
    tgTao: "18/07/2026 13:15:00",
    tgDong: "18/07/2026 15:00:00",
    mayTao: "POS-02",
    ghiChu: "Phòng riêng - họp gia đình",
    slKhach: 6,
    phucVu: "Phan Quỳnh Như",
    quanLy: "Trần Thu Ngân",
    lyDoGiam: "",
  ...
  },
  {
    ...
    nguoiTao: "Dương Thị Mộng Mơ",
    soLanIn: 1,
    tgTao: "18/07/2026 13:30:00",
    tgDong: "18/07/2026 15:20:00",
    mayTao: "POS-01",
    ghiChu: "",
    slKhach: 4,
    phucVu: "Dương Thị Mộng Mơ",
  ...
  },
  {
    ...
    nguoiTao: "Phan Quỳnh Như",
    soLanIn: 1,
    tgTao: "18/07/2026 11:40:00",
    tgDong: "18/07/2026 12:05:00",
    mayTao: "POS-02",
    ghiChu: "",
    slKhach: 1,
    phucVu: "Phan Quỳnh Như",
  ...
  },
  {
    ...
    phucVu: "Dương Thị Mộng Mơ",
    quanLy: "Trần Thu Ngân",
    lyDoGiam: "Khuyến mãi ShopeeFood",
    nhanVienGoiLai: "",
    soLanTamTinh: 1,
    nguoiInCuoi: "Dương Thị Mộng Mơ",
    tgInCuoi: "18/07/2026 12:20:00",
  ...
  },
  {
    ...
    tienCoc: 0,
    thuNgan: "Phan Quỳnh Như",
    khachHang: "beFood #3345",
    nguoiTao: "Phan Quỳnh Như",
    soLanIn: 0,
    tgTao: "18/07/2026 12:25:00",
    tgDong: "",
    mayTao: "POS-02",
    ghiChu: "Đang chờ shipper lấy hàng",
    slKhach: 1,
    phucVu: "Phan Quỳnh Như",
    quanLy: "Trần Thu Ngân",
    lyDoGiam: "",
  ...
  },
  {
    ...
    tienCoc: 0,
    thuNgan: "Dương Thị Mộng Mơ",
    khachHang: "Capichi #067",
    nguoiTao: "Dương Thị Mộng Mơ",
    soLanIn: 1,
    tgTao: "18/07/2026 12:35:00",
    tgDong: "18/07/2026 12:38:00",
    mayTao: "POS-01",
  ...
  },
  {
    ...
    nguoiTao: "Phan Quỳnh Như",
    soLanIn: 1,
    tgTao: "18/07/2026 13:10:00",
    tgDong: "18/07/2026 13:12:00",
    mayTao: "POS-02",
    ghiChu: "",
    slKhach: 1,
    phucVu: "Phan Quỳnh Như",
  ...
  },
  {
    ...
    nguoiTao: "Dương Thị Mộng Mơ",
    soLanIn: 1,
    tgTao: "18/07/2026 13:45:00",
    tgDong: "18/07/2026 13:47:00",
    mayTao: "POS-01",
    ghiChu: "",
    slKhach: 1,
    phucVu: "Dương Thị Mộng Mơ",
  ...
  },
  {
    ...
    tienCoc: 5000000,
    thuNgan: "Dương Thị Mộng Mơ",
    khachHang: "Công ty CP Thực phẩm X",
    nguoiTao: "Dương Thị Mộng Mơ",
    soLanIn: 2,
    tgTao: "18/07/2026 10:00:00",
    tgDong: "18/07/2026 10:30:00",
    mayTao: "POS-01",
    ghiChu: "Giao sỉ lô 1 - 10 thùng",
    slKhach: 1,
    phucVu: "Dương Thị Mộng Mơ",
    quanLy: "Trần Thu Ngân",
    lyDoGiam: "",
  ...
  },
  {
    ...
    type: "distribution",
    date: "2026-07-18",
    soPhieu: "PP3126071800002",
    soHoaDon: "D26MQC",
    dayHD: "D",
    mstKhachHang: "0567890123",
    trangThai: "Đã thanh toán",
    khu: "Khu Giao Nhận",
    ban: "Đại lý B",
    tongTien: 8099400,
    ...
    tienCoc: 2000000,
    thuNgan: "Phan Quỳnh Như",
    khachHang: "Siêu thị Y",
    nguoiTao: "Phan Quỳnh Như",
    soLanIn: 1,
    tgTao: "18/07/2026 10:15:00",
    tgDong: "18/07/2026 10:45:00",
    mayTao: "POS-02",
    ghiChu: "Giao sỉ - 5 thùng",
    slKhach: 1,
    phucVu: "Phan Quỳnh Như",
    quanLy: "Trần Thu Ngân",
    lyDoGiam: "",
...
const sampleItems = ref<any[]>([
  {
    ...
    soOrder: "ORD-001",
    maHang: "VE_NL_1380",
    tenHang: "Vé Người Lớn 1380",
    tenKhac: "Adult Ticket 1380k",
    sl: 2,
    dvt: "Vé",
    donGia: 1388000,
    giamCT: 0,
...
function selectRow(row: any) {
  ...
  if (!row || row.tienHang === 0) {
    sampleItems.value = [];
    return;
  }

  // Generate item detail based on row type and slKhach
  const guests = row.slKhach || 1;
  const baseUnitPrice = Math.round(row.tienHang / guests);
  const items: any[] = [];

  if (row.type === "restaurant") {
    items.push({
      id: 1,
      soOrder: `ORD-${String(row.id).padStart(3, "0")}`,
      maHang: "VE_NL_1380",
      tenHang: "Vé Người Lớn 1380",
      tenKhac: "Adult Ticket 1380k",
      sl: guests,
      dvt: "Vé",
      donGia: baseUnitPrice,
      giamCT: 0,
      giamPhieu: 0,
      giam: row.giam,
      vat: row.vatPercent,
      thue: Math.round(row.thue / guests) * guests,
      tong: row.tongTien,
      liDoTra: "",
    });
    ...
    items.push({
      id: 1,
      soOrder: `RET-${String(row.id).padStart(3, "0")}`,
      maHang: "WAGYU_BOX",
      tenHang: "Hộp bò wagyu nướng",
      tenKhac: "Wagyu Grilled Box",
      sl: 1,
      dvt: "Hộp",
      donGia: row.tienHang,
      giamCT: 0,
  ...
  } else if (row.type === "distribution") {
    const boxes = Math.ceil(guests);
    items.push({
      id: 1,
      soOrder: `DIST-${String(row.id).padStart(3, "0")}`,
      maHang: "BULK_WAGYU",
      tenHang: "Sỉ bò Ngưu Cát cắt lát (Thùng 20kg)",
      tenKhac: "Sliced Wagyu Bulk 20kg",
      sl: boxes,
      dvt: "Thùng",
      donGia: Math.round(row.tienHang / boxes),
      giamCT: 0,
      giamPhieu: 0,
      giam: row.giam,
      vat: row.vatPercent,
  ...
  } else if (row.type === "order_online") {
    items.push({
      id: 1,
      soOrder: `ONL-${String(row.id).padStart(3, "0")}`,
      maHang: "RICE_WAGYU",

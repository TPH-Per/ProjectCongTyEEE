...
const keysVi = {
  ...
  'vouchers.form.customerId': 'Mã Khách Hàng (ID)',
  'vouchers.form.customerUuid': 'UUID Khách hàng',
  ...
  'vouchers.form.assignToCustomer': 'Chỉ định cho khách hàng cụ thể'
};
...
const keysJa = {
  ...
  'vouchers.form.discountValue': '割引額',
  'vouchers.form.assignToCustomer': '特定の顧客に割り当てる'
};
